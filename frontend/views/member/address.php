...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            <h3>收货地址薄</h3>
            <?php $n=1;foreach ($modelall as $value):?>
            <dl class="last"> <!-- 最后一个dl 加类last -->
                <dt><?= $n++.'. '.$value->username.'  '.$value->province.' '.$value->city.' '.$value->zone.' '.$value->tel;?> </dt>
                <dd>
                    <a href=""> <?=\yii\bootstrap\Html::a('修改',['edit-address','id'=>$value->id]) ?></a>
                    <a href=""> <?=\yii\bootstrap\Html::a('删除',['delete-address','id'=>$value->id]) ?></a>
                    <a href=""><?=\yii\bootstrap\Html::a('设为默认地址',['default-address','id'=>$value->id]) ?></a>
                </dd>
            </dl>
            <?php endforeach;?>
        ...
        <div class="address_bd mt10">
            <h4>新增收货地址</h4>
<!--            <form action="/member/address"  method="post" name="address_form">-->
...
<!--                        <input type="text" id="username" name="username" class="txt" />-->
                    ...
                    <li>
                        <div style="display:none;">
                            <?php echo $form->field($model,'province')->hiddenInput(['id'=>"province" ]);?>
                            <?php echo $form->field($model,'city')->hiddenInput(['id'=>"city" ]);?>
                            <?php echo $form->field($model,'zone')->hiddenInput(['id'=>"zone" ]);?>
                        </div>
                        <label for="">所在地区：</label>
                        <div class="info">
                            <div>
                                <select id="s_province" class="txt"></select>  
                                <select id="s_city" class="txt" name="city" ></select> 
                                <select id="s_county" class="txt" name="zone"></select>
                                <script class="resources library" src="<?=Yii::getAlias('@web')?>/js/area.js" type="text/javascript"></script>
                    ...
                    <li>
                        <?php echo $form->field($model,'address')->textInput(['class'=>'txt']);?>
...
<!--                        <input type="checkbox" name="status" class="check" value="1"/>设为默认地址-->
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <?php echo \yii\bootstrap\Html::submitButton('保存',['class'=>'btn']);?>
<!--                        <input type="submit" id="btn"  class="btn" value="保存" />-->
                    </li>
                </ul>
<!--             </form>-->
...
<!-- 底部版权 end -->
<script type="text/javascript" src="<?=Yii::getAlias('@web')?>/js/jquery-1.8.3.min.js"></script>
<script src="<?=Yii::getAlias('@web')?>/js/area.js"></script>
...
//    Gid('s_county').setAttribute('onchange','showArea()');
    ...
    $('#address-status').closest('label').attr('style','width:auto');
