...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl" style="width: 540px">
            <?php $form=\yii\bootstrap\ActiveForm::begin()?>
                <ul>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <?php echo $form->field($model,'remember')->checkbox();echo $form->field($model,'times')->dropDownList(\backend\models\LoginForm::$timesoption,['style'=>'margin-top:5px']);?>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
                        <?php echo \yii\bootstrap\Html::submitButton('',['class'=>'login_btn','style'=>'background:url(../images/login_img.png)']);?>
                    </li>
                </ul>
