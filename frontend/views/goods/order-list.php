    ...
    <div class="content fl ml10">
        ...
        <div class="order_bd mt10">
            <table class="orders">
                ...
                <tbody>
                <?php foreach ($order as $order2):$order_goods=\frontend\models\OrderGoods::find()->where(['order_id'=>$order2->id])->all();foreach ($order_goods as $order_goods2): ?>
                <tr>
                    <td><a href=""><?=$order2->id?></a></td>
                    <td><a href=""><img src="<?=$order_goods2->logo?>" alt="" /></a></td>
                    <td><?=$order2->name?></td>
                    <td>￥<?=$order_goods2->total?> <?=$order2->payment_name?></td>
