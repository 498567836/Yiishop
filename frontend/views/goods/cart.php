...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tbody>
        <?php $total=0; foreach ($models as $value):$total+=$value['shop_price']*$carts[$value['id']];  ?>
        <tr goods_id="<?=$value['id']?>">
            ...
            <td class="col5">￥<span><?=number_format($value['shop_price']*$carts[$value['id']],2)?></span></td>
            <td class="col6"><a href="<?=\yii\helpers\Url::to(['goods/delete-cart'])?>?goods_id=<?=$value['id']?>">删除</a></td>
        </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
    ...
    <div class="cart_btn w990 bc mt10">
        ...
        <a href="<?=\yii\helpers\Url::to(['goods/order'])?>"   onclick="<?=$total==0?'return false':''?>"  class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
